...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'content.create': { roles: ['expert', 'business-owner'], key: 'new-content-created', tenantPath: [], userPath: [] },
  'content.update': { roles: ['expert', 'business-owner'], key: 'content-updated', tenantPath: [], userPath: [] },
  'content.delete': { roles: ['expert', 'business-owner'], key: 'content-deleted', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['expert'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['expert', 'business-owner', 'content-creator'];
